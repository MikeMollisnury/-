...
// @version      1.0
// @description  Сделай вид что этого не видел.
// @author       Mike_Mollisnury
...
const buttons = [
	...
	},
    {
	  title: '| Не по форме |',
	  content:
		'[CENTER][url=https://postimages.org/][url=https://postimg.cc/RJcp1JKx][img]https://i.postimg.cc/RJcp1JKx/R.gif[/img][/url]<br>' +
